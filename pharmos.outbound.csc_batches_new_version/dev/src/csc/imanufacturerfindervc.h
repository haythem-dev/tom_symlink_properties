...
*/
//-------------------------------------------------------------------------------------------------//
#ifndef GUARD_CSCBATCHES_VIEWCONN_IMANUFACTURERFINDERVC_H
#define GUARD_CSCBATCHES_VIEWCONN_IMANUFACTURERFINDERVC_H
...
class IManufacturerFinderVC
{
    public:	
        virtual ~IManufacturerFinderVC(){};
