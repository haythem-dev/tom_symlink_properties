#ifndef GUARD_DOMMOD_LIBABBAUW_ORDERHEADPROTOCOLDM_H
#define GUARD_DOMMOD_LIBABBAUW_ORDERHEADPROTOCOLDM_H
		...
		namespace orderProtocol
		{
			class OrderHeadProtocolDM 
			{
                public:
                    ...
                    void						protocolCreateOrder(const basar::db::aspect::AccessorPropertyTable_YIterator);
			    ...
			    private:
				    OrderHeadProtocolDM(const OrderHeadProtocolDM &r);				// Copy-Konstruktor : abschalten
				    OrderHeadProtocolDM &operator = (const OrderHeadProtocolDM &r);	// Assignment operator : abschalten 
...
#endif // GUARD_DOMMOD_LIBABBAUW_ORDERHEADPROTOCOLDM_H
