...
namespace cscUnitTest
{
	...
	void CopyBatchOrderTestFixture::cleanupDBTables()
	{
		...
		sql_cleanup_orderhead.format("DELETE FROM orderhead WHERE ((branchno = 999) AND (orderno >= 10000) AND (orderno <= 10003)); ");
		basar::VarString sql_cleanup_aorderhead;
		sql_cleanup_aorderhead.format("DELETE FROM aorderhead WHERE ((branchno = 999) AND (orderno >= 10000) AND (orderno <= 10003)); ");
		basar::VarString sql_cleanup_orderpos;
		sql_cleanup_orderpos.format("DELETE FROM orderpos WHERE ((branchno = 999) AND (orderno >= 10000) AND (orderno <= 10003)); ");
		basar::VarString sql_cleanup_aorderpos; 
		sql_cleanup_aorderpos.format("DELETE FROM aorderpos WHERE ((branchno = 999) AND (orderno >= 10000) AND (orderno <= 10003)); ");
