#! /usr/bin/ksh
 ...
 SO_UADM_PATH=${WSS}/de/uadm/sharedlib/release
 
 #LIBRARY PATH 
 readonly LIBRARY_PATH=${LIB_PATH}/servclnt/01.18.01.06/sharedlib/release
 export LD_LIBRARY_PATH=${SO_UADM_PATH}:${LIBRARY_PATH}:$LD_LIBRARY_PATH
 readonly BINARY=eshu.bin
 process="${BIN_PATH}/${BINARY}"
 readonly FORK_BINARY=usradmuiserv
 ...
 #--------------------------------------------------------------------#
 readonly PARAM_PORT=s:global_usradm;
 start="";
 stop="";
 status="";
