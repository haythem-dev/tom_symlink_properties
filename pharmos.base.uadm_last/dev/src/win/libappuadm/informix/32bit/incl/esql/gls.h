...
#if defined (_WIN32) && !defined (_WIN64)
#define GL_VERSION "glslib-6.00.TC4"
#define PLAT_BIT "32"
#elif defined(M64ADDR)
#define GL_VERSION "glslib-6.00.FC4"
#define PLAT_BIT "64"
#elif defined(HPUX_32BIT)
#define GL_VERSION "glslib-6.00.HC4"
#define PLAT_BIT "32"
#else
#define GL_VERSION "glslib-6.00.UC4"
#define PLAT_BIT "32"
#endif

/* Version strings used by DLL version properties box */
#define  GL_VERSION_NUM      6,0,0,4
#if !defined (_WIN64)
#define  GL_VERSION_STR      "6.00.TC4"
#else
#define  GL_VERSION_STR      "6.00.FC4"
#endif

#define GL_NUMVER            600004   /* Numeric version of 6.00.UC4 */
...
int GL_EXPORT GL_PASCAL gl_mbwidth_PUA(gl_lc_t l, gl_e_mcharptr_t mb);
