...
#============================================================================================#
#. /software/etc/profile_prz #Has to be modified to '/software/<target_host>/etc/profile_prz'
. /software/etc/profile_phoenix
#============================================================================================#
# MODUL GLOBAL VARIABLES
#============================================================================================#
export readonly BIN_PATH=/software/wss/rs/tender/bin
export readonly LOG_PATH=/software/wss/rs/tender/log
export readonly INI_PATH=/software/wss/rs/tender/ini
export readonly PROC_PATH=/software/wss/rs/tender/proc
export readonly DATA_PATH=/software/wss/rs/tender/data
export readonly MODULE_PATH=/software/wss/rs/tender
export readonly PROCNAME=$(basename $0);
export readonly LOG_FILE_EXTENSION=log
export readonly LOG_FILE=${PROCNAME}.${LOG_FILE_EXTENSION}
