...
#============================================================================================#
export readonly BIN_PATH=/software/wss/ch/tender/bin
export readonly LOG_PATH=/software/wss/ch/tender/log
export readonly INI_PATH=/software/wss/ch/tender/ini
export readonly PROC_PATH=/software/wss/ch/tender/proc
export readonly DATA_PATH=/software/wss/ch/tender/data
export readonly MODULE_PATH=/software/wss/ch/tender
