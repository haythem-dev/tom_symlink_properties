#ifndef GUARD_DOMMOD_TENDERBATCHPROCESSING_IOMGCUSTOMERCALC_H
#define GUARD_DOMMOD_TENDERBATCHPROCESSING_IOMGCUSTOMERCALC_H
...
} // end namespace omgcustomercalc
} // end namespace domMod
} // end namespace tenderbatchprocessing

//-----------------------------------------------------------------------------------------
#endif // GUARD_DOMMOD_TENDERBATCHPROCESSING_IOMGCUSTOMERCALC_H