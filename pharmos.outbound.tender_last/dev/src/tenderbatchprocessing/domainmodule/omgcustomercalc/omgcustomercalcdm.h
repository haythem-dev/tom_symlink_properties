#ifndef GUARD_DOMMOD_TENDERBATCHPROCESSING_OMGCUSTOMERCALCDM_H
#define GUARD_DOMMOD_TENDERBATCHPROCESSING_OMGCUSTOMERCALCDM_H

//-----------------------------------------------------------------------------------------

#include "iomgcustomercalc.h"
...
class OMGCustomerCalcDM :public IOMGCustomerCalc
{
...
public:
    OMGCustomerCalcDM( );
    //OMGCustomerCalcDM( const basar::db::aspect::AccessorPropertyTable_YIterator );
    ~OMGCustomerCalcDM();
...
private:
    OMGCustomerCalcDM( const OMGCustomerCalcDM & );
    OMGCustomerCalcDM & operator = ( const OMGCustomerCalcDM & );
