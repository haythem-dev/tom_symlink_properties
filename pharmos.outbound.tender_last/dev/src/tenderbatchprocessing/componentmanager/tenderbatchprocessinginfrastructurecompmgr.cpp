...
// include section
//----------------------------------------------------------------------------//
#include "tenderbatchprocessinginfrastructurecompmgr.h"
...
: libutil::componentManager::InfrastructureCompMgrBase< tenderbatchprocessing::componentManager::ApplCompMgr,
                                                    tenderbatchprocessing::infrastructure::cmdLine::TenderbatchprocessingCmdLineEvaluator,
                                                    tenderbatchprocessing::infrastructure::setup::TenderBatchProcessingInfrastructureSetup >( argc, argv, tenderbatchprocessing::LoggerPool::getLoggerTenderbatchprocessing() )
        {
...
void InfrastructureCompMgr::doInjectApplComponentManagerComponents() const
{
    ...
    boost::shared_ptr< const libutil::infrastructure::cmdLine::CmdLineEvaluatorBase<tenderbatchprocessing::infrastructure::cmdLine::AppArgs,libutil::infrastructure::cmdLine::NullCmdLineOptionCollection> > p = getCmdLineEvaluator();
...
{
	infrastructure::mail::MailAlertPtr p = infrastructure::mail::MailAlertPtr(new infrastructure::mail::MailAlert(LoggerPool::getLoggerTenderbatchprocessing()));
