...
namespace tender
{
    namespace viewConn
    {
        ...
        /*!    \throw  no-throw */
        /////////////////////////////////////////////////////////////////////////////////////////////
        TenderSearchCriteriaSwitzerland::TenderSearchCriteriaSwitzerland()
        : m_EventsWiring  ( "TenderSearchCriteriaSwitzerland::EventsWiring"   )
        {
        ...
        void TenderSearchCriteriaSwitzerland::wireEvents()
        {
            ...
            this,                            SLOT  ( onPharmacyGroupIDPickerClicked()));

            connect( ui.btnSupplierNo,       SIGNAL( clicked()),
            this,                            SLOT  ( onSupplierPickerClicked()));
        ...
        void TenderSearchCriteriaSwitzerland::onPharmacyGroupIDPickerClicked()
        {
            libutil::gui::WaitCursor bc( this );
            basar::appl::SystemEventManager::getInstance().fire( "SearchPharmacyGroupRequested" );
        }

        void TenderSearchCriteriaSwitzerland::onSupplierPickerClicked()
        {
            libutil::gui::WaitCursor bc( this );
            basar::appl::SystemEventManager::getInstance().fire( "SearchSupplierRequested" );
        }

		void TenderSearchCriteriaSwitzerland::onSearchClicked()
		{
            METHODNAME_DEF( TenderSearchCriteriaSwitzerland, onSearchClicked )
		...
		void TenderSearchCriteriaSwitzerland::onArticlePickerClicked()
		{
			METHODNAME_DEF( TenderSearchCriteriaSwitzerland, onArticlePickerClicked )

			libutil::gui::WaitCursor bc( this );
			basar::appl::SystemEventManager::getInstance().fire( "SearchArticleRequested" );
		}

		void TenderSearchCriteriaSwitzerland::onCustomerPickerClicked()
		{
			METHODNAME_DEF( TenderSearchCriteriaSwitzerland, onCustomerPickerClicked )

			libutil::gui::WaitCursor bc( this );
			basar::appl::SystemEventManager::getInstance().fire( "SearchCustomerRequested" );
		}

		void TenderSearchCriteriaSwitzerland::onShortcutTriggered()
		{
			METHODNAME_DEF( TenderSearchCriteriaSwitzerland, onShortcutTriggered )
		...
		void TenderSearchCriteriaSwitzerland::onContractDateChanged()
		{
		...
		void TenderSearchCriteriaSwitzerland::onContractPeriodClicked( bool isChecked )
		{
			if( isChecked )
			{
		...
		void TenderSearchCriteriaSwitzerland::focusInEvent( QFocusEvent* event )
		{
			event;
        ...
        void TenderSearchCriteriaSwitzerland::focusOutEvent( QFocusEvent* event )
		{
			event;
            ui.btnSearch->setDefault(false);
		}

		void TenderSearchCriteriaSwitzerland::matchToSearchCriteria( basar::db::aspect::AccessorPropertyTable_YIterator yitSearch )
        {
		...
		void TenderSearchCriteriaSwitzerland::setupSearchCriteria()
		{
			METHODNAME_DEF( TenderSearchCriteriaSwitzerland, setupSearchCriteria )
        ...
        void TenderSearchCriteriaSwitzerland::prepareForNewSearch()
        {
            resetAllInputFields();
        }

        void TenderSearchCriteriaSwitzerland::resetAllInputFields()
        {
            ui.leTenderNo->clear();
        ...
        void TenderSearchCriteriaSwitzerland::injectStatusMapping( libtender::domMod::tender::TenderStateCollectionPtr statusMapping )
        {
        ...
        void TenderSearchCriteriaSwitzerland::injectTypeMapping( libtender::domMod::tender::TenderTypeCollectionPtr typeMapping )
        {
        ...
        const libtender::domMod::tender::TenderTypeCollectionPtr TenderSearchCriteriaSwitzerland::getTypeMapping()
        {
            return m_typeMapping;
        }
        
        const libtender::domMod::tender::TenderStateCollectionPtr TenderSearchCriteriaSwitzerland::getStatusMapping()
        {
            return m_statusMapping;
        }
        
        void TenderSearchCriteriaSwitzerland::setArticleCode( basar::db::aspect::AccessorPropertyTable_YIterator yit )
        {
            METHODNAME_DEF( TenderSearchCriteriaSwitzerland, setArticleCode )
            BLOG_TRACE_METHOD( libtender::LoggerPool::getLoggerViewConn(), fun );
        ...
        void TenderSearchCriteriaSwitzerland::setCustomerNo( basar::db::aspect::AccessorPropertyTable_YIterator yit )
        {
            METHODNAME_DEF( TenderSearchCriteriaSwitzerland, setCustomerNo )
            BLOG_TRACE_METHOD( libtender::LoggerPool::getLoggerViewConn(), fun );
        ...
        void TenderSearchCriteriaSwitzerland::setPharmacyGroupId( basar::db::aspect::AccessorPropertyTable_YIterator yit )
        {
            METHODNAME_DEF( TenderSearchCriteriaSwitzerland, setPharmacyGroupId )
            BLOG_TRACE_METHOD( libtender::LoggerPool::getLoggerViewConn(), fun );
        ...
        void TenderSearchCriteriaSwitzerland::setSupplierNo( basar::db::aspect::AccessorPropertyTable_YIterator yit )
        {
            METHODNAME_DEF( TenderSearchCriteriaSwitzerland, setSupplierNo )
            BLOG_TRACE_METHOD( libtender::LoggerPool::getLoggerViewConn(), fun );

            if( yit.isContainedAndSet( properties::SUPPLIER_NO ) )
            {
                ui.leSupplierNo->setText( QString::number ( yit.getInt32( properties::SUPPLIER_NO ) ) );
            }
        }
