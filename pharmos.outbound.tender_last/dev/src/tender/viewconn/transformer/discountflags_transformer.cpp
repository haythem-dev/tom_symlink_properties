...
namespace tender {
	namespace viewConn {
		...
		void DiscountFlagsTransformer::RightToLeft(GuiPropTabYit guiIt,
			const tender::viewConn::AccPropTabYit accIt)
		{
		...
		//! \throw  no-throw
		//! 
		void DiscountFlagsTransformer::LeftToRight(const GuiPropTabYit guiIt,
			tender::viewConn::AccPropTabYit accIt)
		{
		...
		void DiscountFlagsTransformer::setPropertyValue(tender::viewConn::AccPropTabYit yitAcc, basar::VarString newValue)
		{
			yitAcc.setInt16(m_PropertyName, (basar::Int16)newValue.stoi());
		}

		basar::VarString DiscountFlagsTransformer::getPropertyValue(tender::viewConn::AccPropTabYit yitAcc)
		{
