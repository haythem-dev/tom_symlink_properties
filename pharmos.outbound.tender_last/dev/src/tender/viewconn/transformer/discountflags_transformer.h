...
namespace tender
{
	namespace viewConn
	{
		...
		protected:
			virtual basar::VarString	getPropertyValue(tender::viewConn::AccPropTabYit yitAcc);
			virtual void				setPropertyValue(tender::viewConn::AccPropTabYit yitAcc, basar::VarString newValue);
