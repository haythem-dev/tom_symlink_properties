#ifndef GUARD_TENDER_VIEWCONN_TENDERSEARCHCRITERIAFRANCE_H
#define GUARD_TENDER_VIEWCONN_TENDERSEARCHCRITERIAFRANCE_H
...
#include "ui_tendersearchcriteriafrance.h"
#include <QObject>
#include <QAction>
#pragma warning (pop)
...
namespace tender
{
    namespace viewConn
    {
        ...
        // class declaration
        //-------------------------------------------------------------------------------------------------//
        class TenderSearchCriteriaFrance : public ITenderSearchCriteria
        {
            Q_OBJECT

            public:
                TenderSearchCriteriaFrance();
                ~TenderSearchCriteriaFrance();
            ...
            private:
                ...
                Ui::TenderSearchCriteriaFrance                      ui;
...
#endif //end GUARD_TENDER_VIEWCONN_TENDERSEARCHCRITERIAFRANCE_H
