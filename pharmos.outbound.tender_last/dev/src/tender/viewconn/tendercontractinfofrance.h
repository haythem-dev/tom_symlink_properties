#ifndef GUARD_TENDER_VIEWCONN_TENDERCONTRACTINFOFRANCE_H
#define GUARD_TENDER_VIEWCONN_TENDERCONTRACTINFOFRANCE_H

#pragma warning (push)
#pragma warning(disable: 4127 4231 4244 4251 4311 4312 4481 4511 4512 4800)
#include "ui_tendercontractinfofrance.h"
#include <QObject>
#pragma warning (pop)
...
namespace tender
{
    namespace viewConn
    {
        ...
        // class declaration
        //-------------------------------------------------------------------------------------------------//
        class TenderContractInfoFrance : public ITenderContractInfo
        {
            Q_OBJECT

            public:
                TenderContractInfoFrance();
                ~TenderContractInfoFrance();
				...
				void matchFromPartner( basar::db::aspect::AccessorPropertyTable_YIterator yitPartner );
                
				void matchToCustomerSearch( basar::db::aspect::AccessorPropertyTable_YIterator customerSearchYit );
				void matchToPartnerSearch( basar::db::aspect::AccessorPropertyTable_YIterator partnerSearchYit );
            ...
            private:
                ...
                Ui::TenderContractInfoFrance						ui;
...
#endif //end GUARD_TENDER_VIEWCONN_TENDERCONTRACTINFOFRANCE_H
