#ifndef GUARD_TENDER_VIEWCONN_TENDERCONTRACTINFOBULGARIA_H
#define GUARD_TENDER_VIEWCONN_TENDERCONTRACTINFOBULGARIA_H

#pragma warning (push)
#pragma warning(disable: 4127 4231 4244 4251 4311 4312 4481 4511 4512 4800)
#include "ui_tendercontractinfobulgaria.h"
#include <QObject>
#pragma warning (pop)
...
namespace tender
{
    namespace viewConn
    {
        ...
        // class declaration
        //-------------------------------------------------------------------------------------------------//
        class TenderContractInfoBulgaria : public ITenderContractInfo
        {
            Q_OBJECT

            public:
                TenderContractInfoBulgaria();
                ~TenderContractInfoBulgaria();
            ...
            private:
                ...
                Ui::TenderContractInfoBulgaria						ui;
...
#endif //end GUARD_TENDER_VIEWCONN_TENDERCONTRACTINFOBULGARIA_H
