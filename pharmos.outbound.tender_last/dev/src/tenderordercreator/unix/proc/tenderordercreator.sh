#! /usr/bin/ksh
 ...
 #Purpose:           Starts, stops and status the exemplar binary tenderordercreator for presentation only.    
 ###############################################################################################
 ...
 readonly BINARY=tenderordercreator.bin
 ...
 ###############################################################################################
 . $(dirname $0)/tenderordercreator.option
