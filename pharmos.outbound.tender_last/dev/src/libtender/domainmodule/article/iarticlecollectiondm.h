#ifndef GUARD_LIBTENDER_DOMMOD_ARTICLE_IARTICLECOLLECTIONDM_H
#define GUARD_LIBTENDER_DOMMOD_ARTICLE_IARTICLECOLLECTIONDM_H
...
#endif //end GUARD_LIBTENDER_DOMMOD_ARTICLE_IARTICLECOLLECTIONDM_H
