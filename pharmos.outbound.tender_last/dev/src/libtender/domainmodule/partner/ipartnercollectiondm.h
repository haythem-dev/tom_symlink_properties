#ifndef GUARD_LIBTENDER_DOMMOD_PARTNER_IPARTNERCOLLECTIONDM_H
#define GUARD_LIBTENDER_DOMMOD_PARTNER_IPARTNERCOLLECTIONDM_H
...
{
public:
	virtual ~IPartnerCollectionDM() {}

	virtual void                                                findByPattern( basar::db::aspect::AccessorPropertyTable_YIterator ) = 0;
	virtual void                                                findByPartnerNo( basar::db::aspect::AccessorPropertyTable_YIterator ) = 0;
...
#endif //end GUARD_LIBTENDER_DOMMOD_PARTNER_IPARTNERCOLLECTIONDM_H
