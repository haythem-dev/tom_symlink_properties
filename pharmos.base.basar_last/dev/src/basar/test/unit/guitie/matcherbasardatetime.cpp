/** $Id: matcherbasardatetime.cpp 13993 2009-08-24 15:00:27Z michael.eichenlaub $                                          
*                                                  
* @file                                            
...
SUITE(Matcher_BasarDateTime)
{
	...
	protected:
		BasarDateEdit     * m_date;
		BasarDateTimeEdit * m_datetime1;
		BasarDateTimeEdit * m_datetime2;
		BasarTimeEdit     * m_time;
		BasarDateTimeEdit * m_datetime_date;
		BasarDateTimeEdit * m_datetime_time;
	...
	public:
		...
		bool initGui()
		{
			...
			m_date			= new BasarDateEdit    (defaultDate    , m_widget); 
			m_datetime1		= new BasarDateTimeEdit(defaultDateTime, m_widget); 
			m_datetime2		= new BasarDateTimeEdit(defaultDateTime, m_widget); 
			m_time			= new BasarTimeEdit    (defaultTime    , m_widget); 
			m_datetime_date = new BasarDateTimeEdit(defaultDateTime, m_widget); 
			m_datetime_time = new BasarDateTimeEdit(defaultDateTime, m_widget); 
