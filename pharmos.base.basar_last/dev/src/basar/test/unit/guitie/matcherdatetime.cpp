...
SUITE(Matcher_DateTime)
{
	...
	protected:
		...
		QDateTimeEdit * m_datetime2;
		QTimeEdit     * m_time;
		QDateTimeEdit * m_datetime_date;
		QDateTimeEdit * m_datetime_time;
	...
	public:
		...
		bool initGui()
		{
			...
			m_date			= new QDateEdit    (defaultDate    , m_widget); 
			m_datetime1		= new QDateTimeEdit(defaultDateTime, m_widget); 
			m_datetime2		= new QDateTimeEdit(defaultDateTime, m_widget); 
			m_time			= new QTimeEdit    (defaultTime    , m_widget); 
			m_datetime_date = new QDateTimeEdit(defaultDateTime, m_widget); 
			m_datetime_time = new QDateTimeEdit(defaultDateTime, m_widget); 
