...
#ifndef GUARD_BASARDATETIMEEDITPLUGIN_H
#define GUARD_BASARDATETIMEEDITPLUGIN_H
...
//----------------------------------------------------------------------------
/*! \brief  to make a plugin for datetime edit widget.

	final class
*/
class BasarDateTimeEditPlugin : public QObject, 
...
public:
	//! c'tor	\n no-throw
						BasarDateTimeEditPlugin	(QObject *parent = 0					//!< parent widget
												);
