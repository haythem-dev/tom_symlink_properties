#ifndef GUARD_DOMMOD_CSCBATCHHISTORY_ORDERPROTOCOLENUMS_H
#define GUARD_DOMMOD_CSCBATCHHISTORY_ORDERPROTOCOLENUMS_H
...
#endif // GUARD_DOMMOD_CSCBATCHHISTORY_ORDERPROTOCOLENUMS_H
