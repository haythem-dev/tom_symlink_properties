 ...
 */
//------------------------------------------------------------------------------------------------------------------//
#ifndef GUARD_FLAGTRANSFORMER_H
#define GUARD_FLAGTRANSFORMER_H
...
namespace CSC_Batches
{
    ...
    public:
        ...
        /*! \n no-throw*/
                        FlagTransformer  ( const basar::VarString& GUIPropertyName, const basar::VarString& DBPropertyName, BasarTableWidget* table, bool markRed = false );
...
#endif // end GUARD_FLAGTRANSFORMER_H
