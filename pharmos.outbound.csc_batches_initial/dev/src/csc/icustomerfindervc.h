...
*/
//-------------------------------------------------------------------------------------------------//
#ifndef GUARD_CSC_BATCHES_VIEWCONN_ICUSTOMERFINDERVC_H
#define GUARD_CSC_BATCHES_VIEWCONN_ICUSTOMERFINDERVC_H
...
class ICustomerFinderVC
{
    public:	
        virtual ~ICustomerFinderVC(){};
